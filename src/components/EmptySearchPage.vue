<template>
  <div>
      <div class="tw-flex tw-flex-col tw-items-center tw-my-32 tw-p-4 tw-text-center tw-justify-center">
          <svg width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 class="tw-mt-4">Sorry! We couldn't find any properties for your search.</h3>
      </div>
  </div>
</template>
